...
# 通知配置 (2025-12-29 更新：移除Ntfy/Gotify/Bark/Telegram，添加钉钉/飞书)
WX_BOT_URL = os.getenv("WX_BOT_URL")
DINGTALK_BOT_URL = os.getenv("DINGTALK_BOT_URL")
...
# ========================================================================
# [已禁用 - 2025-12-29] 代理池配置
# 原功能：管理代理池的配置（启用状态、代理文件、策略等）
#
# 原配置：
#   USE_PROXY_POOL = os.getenv("USE_PROXY_POOL", "false").lower() == "true"
#   PROXY_POOL_FILE = os.getenv("PROXY_POOL_FILE", "proxies.json")
#   PROXY_STRATEGY = os.getenv("PROXY_STRATEGY", "smart")
#   PROXY_VERIFY_TIMEOUT = int(os.getenv("PROXY_VERIFY_TIMEOUT", "10"))
#
# 当前状态：已强制禁用
# 移除原因：代理池功能不好用，后续重新规划
# ========================================================================
USE_PROXY_POOL = False  # [已禁用] 强制关闭代理池功能
PROXY_POOL_FILE = os.getenv("PROXY_POOL_FILE", "proxies.json")
PROXY_STRATEGY = os.getenv("PROXY_STRATEGY", "smart")  # smart, random, round_robin
PROXY_VERIFY_TIMEOUT = int(os.getenv("PROXY_VERIFY_TIMEOUT", "10"))
